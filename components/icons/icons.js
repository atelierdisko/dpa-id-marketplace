    ...
    case "dpaPictureAlliance":
      return (
        <svg
          ...
          className={className}
        >
          <rect x="12" y="12" width="74" height="74" fill="url(#pattern0)" />
          <defs>
            <pattern
              id="pattern0"
    ...
    case "genericIcon":
      return (
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <circle cx="16" cy="16.0005" r="16" fill="#FD7239" />
        </svg>
      );
    case "show":
      return (
