...
export default function Funktionalitaten({functionalities,filters,className}) {
    return (
        <section className={joinClassNames(grid.root,styles.root,className)}>
            <h2 className={joinClassNames(typography.gamma500,styles.title)}>Die Welt der dpa ID im Überblick</h2>
            <p className={joinClassNames(typography.delta400,styles.description)}>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata.</p>
